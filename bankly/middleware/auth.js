...
/** Authorization Middleware: Requires user is the correct user or admin*/
/* added this function to fix bug #4 */

function requireCorrectUserOrAdmin(req, res, next) {
  try {
